...
<html lang="en">
    <head>
        ...
        <title>PPDB ONLINE | SD IT ABDULLAH BIN NUH</title>
		 <!-- META DISKRIPSI-->
		<meta name="description" content="Mari bergabung Bersama Kami di SD IT ABDULLAH BIN NUH, Pendaftaran Peserta didik Baru Tahun <?= date('Y') ?> Kembali dibuka ">
        ...
        <link rel="shortcut icon" href="assets/img/logo/logo_abn.png" />
                ...
                <div class="container mt-5">
                    <div class="row">
                                    ...
                                    <div class="carousel-item active">
                                        <div>
                                            ...
                                            <p data-animation="animated slideInRight" data-delay="1s">
                                                Aplikasi Penerimaan Peserta didik baru Tahun Pelajaran 2025/2026 SD IT ABDULLAH BIN NUH.
                                            </p>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="card-body">
                                <img src="assets/img/logo/ppdb abn.png" alt="" width="100%" style="margin-bottom: 20px;"> <form id="form-login">
...
<?php } ?>
                <section class="bg-light statistik" id="statistik">
                    <div class="container">
                        ...
                        <h6 class="text-center">Peserta Didik Baru SD IT ABDULLAH BIN NUH Tahun 2025</h6>
                        <div class="row mt-12">
                            <div class="col-sm-6">
                                <div class="card mt-2">
